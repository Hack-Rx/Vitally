  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          int calConsumed =
              (snapshot.data.documents[1]['CaloriesConsumed']) == null
                  ? 0
                  : (snapshot.data.documents[1]['CaloriesConsumed']);
          int dailyCal = (snapshot.data.documents[1]['DailyCal']) == null
              ? 0
              : (snapshot.data.documents[1]['DailyCal']);
          double percentage = (calConsumed / dailyCal) * 100;
          int perc = percentage.toInt();
          int protienDaily = ((0.1 * dailyCal) ~/ 4);
          int fatsDaily = ((0.25 * dailyCal) ~/ 9);
          int dailyCarbs = ((0.45 * dailyCal) ~/ 4);
          int protienintake = 0;
          int fatsintake = 0;
          int carbsintake = 0;
          ...
          return Container(
            ...
            color: Colors.white,
            child: Padding(
              padding: const EdgeInsets.only(top: 144.0, left: 22, right: 22),
              child: Column(
                    ...
                    children: <Widget>[
                      Container(
                          ...
                          decoration: BoxDecoration(
                            color: protienintake > protienDaily
                                ? Colors.redAccent
                                : Color(0xFF17C6D8),
                            boxShadow: [
                              BoxShadow(
